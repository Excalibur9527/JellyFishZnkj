...
当前项目工作台中的演员 / 场景 / 道具 / 服装页签，采用统一的资产展示语义：

- 页面展示“当前项目可见的资产卡片”，而不是只展示已关联资产
- 已关联资产显示 `已关联` 状态，并提供“从项目移除”
- 未关联资产显示 `未关联` 状态，并提供“关联到项目”
- “彻底删除”始终表示删除资产本体，不等同于项目级移除

因此，项目级移除后，资产仍可继续在工作台中以“未关联”状态显示，并允许重新关联或彻底删除。
